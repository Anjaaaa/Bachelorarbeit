...
%Note that there is no qualitative difference between $q_\chi=1$ and $q_\chi=\sfrac{1}{6}$, due to $\sigma_{0,\text{loop}},\sigma_{0,\text{tree}}\propto q_\chi^2$.
